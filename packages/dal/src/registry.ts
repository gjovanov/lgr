...
import type {
  ...
  IProduct, IWarehouse, IStockLevel, IStockMovement, IInventoryCount, IPriceList, ICostLayer, IProductCategory,
...
export interface RepositoryRegistry {
  ...
  productCategories: IBatchRepository<IProductCategory>
