      ...
      <v-card-text>
        ...
        >
          ...
          <template #item.contactName="{ item }">
            <entity-link v-if="item.contactId" :label="item.contactName || ''" :href="`/invoicing/contacts/${item.contactId}/edit`" />
...
interface Item { _id: string; number?: string; type: string; date: string; fromWarehouseName?: string; toWarehouseName?: string; fromWarehouseId?: string; toWarehouseId?: string; contactId?: string; contactName?: string; status: string; total?: number; lines?: any[]; notes?: string }
